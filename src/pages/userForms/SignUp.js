...
const SignUp = () => {
    ...
    useEffect(() => {
        if (
            password === undefined || password === "" || confirmPassword === undefined || confirmPassword === "" || password !== confirmPassword
        ) {
            setDisabled(true);
        } else {
            setDisabled(false)
    ...
    let inputClass = "block   px-2.5 pb-2.5 pt-5 w-full text-md text-black bg-gray-50 dark:bg-gray-300 border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer";
