                ...
                <div className='w-1/2 mx-12 '>
                    ...
                    <div className='w-full  grid place-items-center'>
                        <div className='bg-[#FFFAF4] rounded-lg grid place-items-center p-10'>
                            ...
                            <div className='flex mt-3'><div className=' mx-auto'><button onClick={() => dispatch(googleLogin())} className="px-3 py-3   rounded-full border border-gray-800  hover:bg-slate-200 ">   <FcGoogle /></button></div></div>
                            </form>
                        </div>
                    </div>
            </div>
